...
import { Loader2, Loader2Icon, LogOut, PhoneOffIcon } from "lucide-react";
...
function SessionPage() {
  ...
  const handleEndSession = () => {
    if (confirm("Are you sure you want to end the session? All participants will be notified.")) {
      // host will be navigated to dashboard
      ...
      <div className="h-screen bg-base-100 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <Loader2Icon className="w-12 h-12 animate-spin mx-auto text-primary" />
  ...
  if (!session) {
    return (
      <div className="h-screen bg-base-100 flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <p className="text-error text-xl mb-4">Session not found</p>
    ...
    <div className="h-screen bg-base-100 flex flex-col">
      ...
      <div className="flex-1">
        <PanelGroup direction="horizontal">
          {/* LEFT PANEL - CODE EDITOR AND PROBLEM DETAILS */}
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        ...
                        <p className="text-base-content/60 mt-2">
                          Host: {session.host?.name || "Loading..."} - {session.participant ? 2 : 1}/2 participant
                        </p>
                      </div>
                      <div className="flex items-center gap-3">
                        <span className={`badge badge-lg ${getDifficulty(session.difficulty)}`}>
