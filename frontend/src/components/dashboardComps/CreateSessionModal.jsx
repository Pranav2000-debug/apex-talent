    ...
    <div className="modal modal-open">
      <div className="modal-box max-w-2xl">
        ...
        <div className="space-y-8">
          <div className="space-y-2">
            <label className="label">
              <label className="label-text font-semibold">Select Problem</label>
              <span className="label-alt text-error">*</span>
            </label>
            ...
            <select
              ...
              onChange={(e) => {
                const selectProblem = problems.find((p) => p.title === e.target.value);
                setRoomConfig({ difficulty: selectProblem.difficulty, problem: e.target.value });
              }}>
        ...
        <div className="modal-action">
          ...
          <button className="btn btn-primary gap-2" onClick={onCreateRoom} disabled={isCreating || !roomConfig.problem}>
